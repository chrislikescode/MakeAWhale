            ...
            <Grid container spacing={2} direction="row-reverse">
                ...
                <Grid item id="NoWeb3Item" xs={12} sm={12} md={6}>
                    <div id="NoWeb3Div" className="flex"> 
                        <h2 className="text_white big_text noweb3_tex noweb3_greeting">Welcome to the Crypto Lottery!<span role="img" aria-label="whale" className="noweb3_emoji"> 🐋 </span> </h2> 
